...
from tensorforce_benchmark.util import hash_object
...
class ExperimentData(dict):
    ...
    def hash(self):
        ...
        # Benchmark hash identifies runs on the same config, environment and tensorflow/tensorforce version
        ...
        benchmark_hash = hash_object([
            ...
            metadata['tensorflow_version'],
            metadata['tensorforce_version']
        ])
